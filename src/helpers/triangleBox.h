#ifndef __TRIANGLEBOX_H__
#define __TRIANGLEBOX_H__

#include <cmath>
#include <glm/glm.hpp>

namespace TriangleBox {
  ...
  inline bool test(glm::vec3 boxcenter, glm::vec3 boxhalfsize, glm::vec3 tv0, glm::vec3 tv1,
    glm::vec3 tv2) {
